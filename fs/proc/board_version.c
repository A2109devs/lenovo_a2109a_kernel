...
static int board_version_proc_show(struct seq_file *m, void *v)
{
	...
	switch(board_strap)
	{
		case CL2N_BOARD_VER_A00: seq_printf(m, "A00"); break;
		case CL2N_BOARD_VER_B00: seq_printf(m, "B00"); break;
		case CL2N_BOARD_VER_C00: seq_printf(m, "C00"); break;
		case CL2N_BOARD_VER_D00: seq_printf(m, "D00"); break;
		default:
