                       ...
                       uint bustype, void *sdh, char **vars, uint *varsz)
{
	...
	//&*&*&*JohWan1 Show BCM4330 chip version
	printf("sih->chiprev = %d, ", sih->chiprev);
	if (sih->chiprev == BCM43362A0_CHIP_REV)
		printf("chip rev is A0\n");
	else if (sih->chiprev == BCM43362A2_CHIP_REV)
		printf("chip rev is A2\n");
	else if (sih->chiprev == BCM4330B1_CHIP_REV)
		printf("chip rev is B1\n");
	else if (sih->chiprev == BCM4330B2_CHIP_REV)
		printf("chip rev is B2\n");
	else
		printf("Warning, Unable recognize chip rev.\n");
	//&*&*&*JohWan2 Show BCM4330 chip version
